...
export const ChatPanel = memo(function ChatPanel({
  ...
  return (
    <aside
      className={cn(
        'animate-panel-in grid h-full min-h-0 w-full self-stretch overflow-hidden rounded-lg border border-border bg-surface text-foreground shadow-2xl lg:w-[25rem] xl:w-[29rem]',
        className
      )}
    >
...
function areChatPanelPropsEqual(
  previous: ChatPanelProps,
  next: ChatPanelProps
): boolean {
  return (
